...
CREATE TABLE "clientes_mikrowisp" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE "servicios_mikrowisp" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ...
  "ip" varchar NOT NULL,
  "instalado" date,
  "pppuser" varchar NOT NULL,
  "ppppass" varchar NOT NULL,
  "tiposervicio" varchar NOT NULL,
  "status_user" varchar NOT NULL,
  "coordenadas" varchar,
  "direccion" varchar,
  "snmp_comunidad" varchar,
  "perfil" varchar NOT NULL,
  "created_at" timestamp NOT NULL DEFAULT (now()),
  "updated_at" timestamp NOT NULL DEFAULT (now())
);

CREATE TABLE "facturacion_mikrowisp" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "id_cliente" integer NOT NULL,
  "facturas_nopagadas" integer NOT NULL,
  "total_facturas" decimal(10,2) NOT NULL,
  "created_at" timestamp NOT NULL DEFAULT (now()),
  "updated_at" timestamp NOT NULL DEFAULT (now())
);
...
ALTER TABLE "servicios_mikrowisp" ADD FOREIGN KEY ("id_cliente") REFERENCES "clientes_mikrowisp" ("id");

ALTER TABLE "facturacion_mikrowisp" ADD FOREIGN KEY ("id_cliente") REFERENCES "clientes_mikrowisp" ("id");
